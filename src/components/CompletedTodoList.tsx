...
const CompletedTodoList = (props: CompeletedTodosProps) => {
  return (
    <li className="border-gray-400  flex flex-row py-2">
      <div className="select-none bg-white flex flex-1 items-center p-4 transition duration-500 ease-in-out transform hover:-translate-y-2 rounded-2xl border-2 p-6 hover:shadow-2xl border-blue-400">
